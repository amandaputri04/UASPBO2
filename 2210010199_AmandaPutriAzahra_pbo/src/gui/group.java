...
public class group extends javax.swing.JFrame {
    cruddb mycrud;
    String fieldgroup[]={"id","name"};
    String judulkolom[]={"id","name"};
    int lebarkolom[]={150,150};
    String Sql="SELECT * FROM `perancangan_tabel_group`";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String isi[]={jTextField1.getText(),jTextField2.getText() };
        mycrud.SimpanDinamis("`perancangan_tabel_group`", fieldgroup, isi);
    ...
    if (id.isEmpty() || jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() ) {
        javax.swing.JOptionPane.showMessageDialog(this, "Semua field harus diisi!");
        return;
    }

    // Panggil metode EditDinamis
    mycrud.EditDinamis("`perancangan_tabel_group`", "id", id, field, value);
    ...
    if (konfirmasi == javax.swing.JOptionPane.YES_OPTION) {
        ...
        mycrud.HapusDinamis("`perancangan_tabel_group`", "id", id);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jTextField3.getText().isEmpty()){
            ...
            sql="select* from `perancangan_tabel_group`";
        }
        else{
        
            sql="select*from `perancangan_tabel_group` where id ='"+jTextField3.getText()+"'";
        }
        mycrud.tampilLaporan("E:\\tugas pbo last\\2210010199_AmandaPutriAzahra_pbo\\src\\laporan\\Lgroup.jrxml", sql);
