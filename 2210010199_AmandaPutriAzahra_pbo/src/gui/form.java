...
public class form extends javax.swing.JFrame {
    cruddb mycrud;
    String fieldform[]={"no","nama","tglm","tgla","alasan","file","nopeg"	

};
    String judulkolom[]={"no","nama","tglm","tgla","alasan","file","nopeg"};
    int lebarkolom[]={150,150,150,150,150,150,150};
    String Sql="SELECT * FROM `perancangan_tabel_form`";
    ...
    private void initComponents() {
        ...
        jLabel7.setText("nopeg");

        jLabel3.setText("tglm");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        mycrud.SimpanDinamis("`perancangan_tabel_form`", fieldform, isi);
    ...
    String[] field = {"no","nama","tglm","tgla","alasan","file","nopeg"};
    String[] value = {
    ...
    if (id.isEmpty() || jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty() || jTextField6.getText().isEmpty() || jTextField7.getText().isEmpty()  ) {
        javax.swing.JOptionPane.showMessageDialog(this, "Semua field harus diisi!");
        return;
    }

    // Panggil metode EditDinamis
    mycrud.EditDinamis("`perancangan_tabel_form`", "no", id, field, value);
    ...
    if (konfirmasi == javax.swing.JOptionPane.YES_OPTION) {
        ...
        mycrud.HapusDinamis("`perancangan_tabel_form`", "no", id);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jTextField8.getText().isEmpty()){
            ...
            sql="select* from `perancangan_data_form`";
        }
        else{
        
            sql="select*from `perancangan_tabel_form` where no ='"+jTextField8.getText()+"'";
        }
        mycrud.tampilLaporan("E:\\tugas pbo last\\2210010199_AmandaPutriAzahra_pbo\\src\\laporan\\Lform.jrxml", sql);
